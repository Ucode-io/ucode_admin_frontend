...
// import useQueryClient, { createQueryClient } from "./queries";
...
ModuleRegistry.registerModules([ClientSideRowModelApiModule, RowApiModule]);
...
function App() {
  ...
  const resetQueryClient = () => {
    setKey(Date.now()); // ПЕРЕСОЗДАЁТ QueryClientProvider
  };
    ...
    <Suspense fallback="Loading...">
      <div className="App">
        <GoogleOAuthProvider clientId="471439990521-hfd3oreqct00ittfsmv4f2n07bab93bf.apps.googleusercontent.com">
          <QueryClientProvider key={key} client={queryClient}>
                ...
                <MaterialUIProvider>
                  <MantineProvider>
                    <AlertProvider>
                      ...
                      <BrowserRouter>
                        <AliveScope>
                          <Router resetQueryClient={resetQueryClient} />
                        </AliveScope>
                      </BrowserRouter>
                    </AlertProvider>
                  </MantineProvider>
