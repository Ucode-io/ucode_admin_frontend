...
const HFTextFieldLanguage = ({
  ...
  const updateVal = (val) => languageService.updateLanguageKey(val);

  const inputChangeHandler = useDebounce((val) => updateVal(val), 600);
...
export default HFTextFieldLanguage;
