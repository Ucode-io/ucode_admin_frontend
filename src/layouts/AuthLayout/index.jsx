...
const AuthLayout = () => {
  ...
  const subdomain = window.location.hostname === 'localhost' ? 'ett.u-code.io' : window.location.hostname
  ...
  const microfrontendLink = microfrontendUrl ? `https://${microfrontendUrl}/assets/remoteEntry.js` : undefined
