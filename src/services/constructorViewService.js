...
const constructorViewService = {
  getList: (tableSlug, params) => requestV2.get(`/views/${tableSlug}`, { params }),
  update: (tableSlug, data) => requestV2.put(`/views/${tableSlug}/update-order`, data),
  ...
  changeViewOrder: (data, tableSlug) => request.put(`/iews/${tableSlug}/update-order`, data),
};
