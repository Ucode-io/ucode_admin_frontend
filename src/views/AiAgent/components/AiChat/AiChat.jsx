          ...
          <span className={cls.inspectIcon}>
            ...
            >
              <g>
                ...
                <g fill="#b3404a">
                  <path
                    d="m62.323 34.054-38-13a1 1 0 0 0-1.274 1.255l13 40a1 1 0 0 0 .909.689H37a1 1 0 0 0 .922-.612l7.85-18.647 16.654-7.836a1 1 0 0 0-.1-1.851zm-25.2 25.083L26.238 25.653l17.579 17.579zM45.21 41.8 27.756 24.342l31.584 10.8zM25 37h2v2h-2zM21 37h2v2h-2zM17 37h2v2h-2zM13 37h2v2h-2zM9 37h2v2H9zM5 37h2v2H5zM21 1h2v2h-2zM17 1h2v2h-2zM13 1h2v2h-2zM33 1h2v2h-2zM37 1h2v2h-2zM29 1h2v2h-2zM25 1h2v2h-2zM9 1h2v2H9zM5 1h2v2H5zM1 37h2v2H1zM1 33h2v2H1zM1 29h2v2H1zM1 25h2v2H1zM1 21h2v2H1zM1 17h2v2H1zM1 13h2v2H1zM1 9h2v2H1zM1 5h2v2H1zM37 21h2v2h-2zM37 17h2v2h-2zM37 13h2v2h-2zM37 9h2v2h-2zM37 5h2v2h-2zM1 1h2v2H1z"
                    fill="#9dcdef"
                    opacity="1"
                    data-original="#b3404a"
                    className=""
                  ></path>
                </g>
              </g>
            ...
            <span className={cls.sendIcon}>
              ...
              >
                <g>
                  ...
                  ></path>
                  <path
                    d="M12.285 12.775a.749.749 0 1 1-1.06-1.06l9.801-9.801a.749.749 0 1 1 1.06 1.06z"
                    fill="#ffffff"
                    opacity="1"
                    data-original="#000000"
                  ></path>
