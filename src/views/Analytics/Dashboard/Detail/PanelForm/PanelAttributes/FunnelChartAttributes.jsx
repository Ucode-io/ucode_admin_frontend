...
const FunnelChartAttributes = ({ control, columns }) => {

  const attributeSections = useMemo(() => (
    [
      {
        label: 'Funnel chart attributes',
        fields: [
          {
            label: 'Key field slug',
            slug: 'attributes.FUNNEL_CHART.label_field_slug',
            type: "PICK_LIST",
            attributes: { options: columns }
          },
          {
            label: 'Value field slug',
            slug: 'attributes.FUNNEL_CHART.value_field_slug',
            type: "PICK_LIST",
            attributes: { options: columns }
          }
        ]
...
export default FunnelChartAttributes
