...
export const useExamplesProps = ({ item }) => {
  ...
  const examples = {
            ...
            <ExampleBlock>
              ...
              <Box className={cls.typeBadge}>
                {typeof item?.icon === "string" ? (
                  <img src={item?.icon} width={11} height={11} alt="" />
                ) : (
                  item?.icon
                )}
                {item?.attributes?.[`label_${i18n.language}`] || item?.label}
              </Box>
              <Box className={cls.punctuation}>,</Box>&nbsp;0, 5
              <Box className={cls.punctuation}>)</Box>
            </ExampleBlock>
            <ExampleBlock>
    ...
    LOOKUP: {
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="8px" marginTop="8px">
          <Box display="flex" flexDirection="column" gap="4px">
            <Box
              className={cls.exampleWrapper}
              border="1px solid rgba(84, 72, 49, 0.08)"
              borderRadius="5px"
              fontSize="11px"
              padding="6px"
            >
    ...
    NUMBER: {
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <Box
            className={cls.exampleWrapper}
            border="1px solid rgba(84, 72, 49, 0.08)"
            borderRadius="5px"
    ...
    DATE_TIME_WITHOUT_TIME_ZONE: {
      name: "Date time (TZ-)",
      icon: getColumnIconPath({
        column: FIELD_TYPES.DATE_TIME_WITHOUT_TIME_ZONE,
      }),
      suppressHeader: true,
      content: (
        <Box display="flex" flexDirection="column" gap="8px" marginTop="8px">
        ...
        <Box display="flex" flexDirection="column" gap="8px" marginTop="8px">
          ...
          <Box display="flex" flexDirection="column" gap="4px">
            ...
            >
              ...
              <Box className={cls.punctuation}>,</Box>&nbsp;
              <Box className={cls.string}>"Checked"</Box>
              <Box className={cls.punctuation}>,</Box>&nbsp;
              <Box className={cls.string}>"Unchecked"</Box>
              <Box className={cls.punctuation}>)</Box>
            </Box>
            <Box
              className={cls.exampleWrapper}
            ...
            >
              ...
              , <Box className={cls.string}>"Yes"</Box>, true,{" "}
              <Box className={cls.string}>"No"</Box>
              <Box className={cls.punctuation}>)</Box>
            </Box>
          </Box>
        </Box>
        ...
        <Box display="flex" flexDirection="column" gap="8px" marginTop="8px">
          ...
          <Box display="flex" flexDirection="column" gap="4px">
            ...
            >
              ...
              <Box className={cls.punctuation}>,</Box>&nbsp;
              <Box className={cls.string}>"On"</Box>
              <Box className={cls.punctuation}>,</Box>&nbsp;
              <Box className={cls.string}>"Off"</Box>
              <Box className={cls.punctuation}>)</Box>
            </Box>
            <Box
              className={cls.exampleWrapper}
            ...
            >
              ...
              , <Box className={cls.string}>"Enabled"</Box>, true,{" "}
              <Box className={cls.string}>"Disabled"</Box>
              <Box className={cls.punctuation}>)</Box>
            </Box>
          </Box>
        </Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <ExampleBlock>
            <Box className={cls.function}>ifs</Box>
            <Box className={cls.punctuation}>(</Box>
            true, 1, true, 2, 3<Box className={cls.punctuation}>)</Box>
            &nbsp;= 1
          </ExampleBlock>
          <ExampleBlock>
            <Box className={cls.function}>ifs</Box>
            <Box className={cls.punctuation}>(</Box>
            false, 1, false, 2, 3<Box className={cls.punctuation}>)</Box>
            &nbsp;= 3
          </ExampleBlock>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            2, 2<Box className={cls.punctuation}>)</Box>
            &nbsp;= true
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            2, 3<Box className={cls.punctuation}>)</Box>
            &nbsp;= false
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            <Box className={cls.function}>and</Box>
            <Box className={cls.punctuation}>(</Box>
            3&nbsp;<Box className={cls.operator}>&gt;</Box>&nbsp;2, 2&nbsp;
            <Box className={cls.operator}>&lt;</Box>&nbsp;3
            <Box className={cls.punctuation}>)</Box>
            &nbsp;= false
          </Box>
        </Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            [1, 2, 3], 1<Box className={cls.punctuation}>)</Box>
            &nbsp;= 2
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            [1, 2, 3, 4], 1, 3<Box className={cls.punctuation}>)</Box>
            &nbsp;= [2, 3]
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            5, 2<Box className={cls.punctuation}>)</Box>
            &nbsp;= 3
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            10, 2<Box className={cls.punctuation}>)</Box>
            &nbsp;= 5
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            7, 3<Box className={cls.punctuation}>)</Box>
            &nbsp;= 1
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            1, 3, 2<Box className={cls.punctuation}>)</Box>
            &nbsp;= 1
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            1, 2, 3<Box className={cls.punctuation}>)</Box>
            &nbsp;= 6
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            2, 4<Box className={cls.punctuation}>)</Box>
            &nbsp;= 3
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>9
            <Box className={cls.punctuation}>)</Box>
            &nbsp;= 3
          </Box>
        </Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>1
            <Box className={cls.punctuation}>)</Box>
            &nbsp;≈ 2.718
          </Box>
        </Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>8
            <Box className={cls.punctuation}>)</Box>
            &nbsp;= 3
          </Box>
        </Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.string}>"Hello"</Box>
            <Box className={cls.punctuation}>,</Box>
            0, 2<Box className={cls.punctuation}>)</Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>[
            <Box className={cls.string}>"a"</Box>,{" "}
            <Box className={cls.string}>"b"</Box>],{" "}
            <Box className={cls.string}>"-"</Box>
            <Box className={cls.punctuation}>)</Box>
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            <Box className={cls.function}>includes</Box>
            <Box className={cls.punctuation}>(</Box>
            [1, 2, 3], 2<Box className={cls.punctuation}>)</Box>
            &nbsp;= true
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            ...
            <Box className={cls.punctuation}>(</Box>
            [1, 2], x * 2<Box className={cls.punctuation}>)</Box>
            &nbsp;= [2, 4]
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <Box
            ...
            padding="6px"
          >
            3 <Box className={cls.punctuation}>&lt;=</Box> 5 →{" "}
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <Box
            ...
            padding="6px"
          >
            7 <Box className={cls.punctuation}>&gt;=</Box> 7 →{" "}
            <Box className={cls.function}>true</Box>
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <Box
            ...
            padding="6px"
          >
            10 <Box className={cls.punctuation}>&gt;</Box> 5 →{" "}
            <Box className={cls.function}>true</Box>
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <Box
            ...
            padding="6px"
          >
            3 <Box className={cls.punctuation}>&lt;</Box> 8 →{" "}
            <Box className={cls.function}>true</Box>
          </Box>
        </Box>
      ),
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          <Box
            ...
            padding="6px"
          >
            5 <Box className={cls.punctuation}>+</Box> 7 → 12
          </Box>
        </Box>
      ),
    },
      ...
      content: (
        <Box display="flex" flexDirection="column" gap="4px" marginTop="8px">
          ...
          >
            <Box className={cls.punctuation}>!</Box>
            <Box className={cls.function}>true</Box> →{" "}
            <Box className={cls.function}>false</Box>
          </Box>
        </Box>
      ),
    },
