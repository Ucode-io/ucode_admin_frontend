...
export const FieldParams = ({ 
  ...
  return <Box>
    <Box className={cls.header}>
      <p className={cls.title}>Edit fields</p>
        ...
        <Box>
          <Box paddingX="8px">
            <FieldMenuItem 
              ...
              icon={
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1.33325 9.66687L7.7614 12.8809C7.84886 12.9247 7.89259 12.9465 7.93845 12.9551C7.97908 12.9628 8.02076 12.9628 8.06139 12.9551C8.10725 12.9465 8.15098 12.9247 8.23843 12.8809L14.6666 9.66687M1.33325 6.33354L7.7614 3.11946C7.84886 3.07574 7.89259 3.05387 7.93845 3.04527C7.97908 3.03765 8.02076 3.03765 8.06139 3.04527C8.10725 3.05387 8.15098 3.07574 8.23843 3.11946L14.6666 6.33354L8.23843 9.54762C8.15098 9.59134 8.10725 9.61321 8.06139 9.62181C8.02076 9.62943 7.97908 9.62943 7.93845 9.62181C7.89259 9.61321 7.84886 9.59134 7.7614 9.54762L1.33325 6.33354Z" stroke="#101828" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
              }
              value={activeType?.[`label_${i18n.language}`] || activeType?.label}
          ...
          <Box paddingX="8px">
            <FieldMenuItem
              ...
              title="Validation"
              icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><g clip-path="url(#a)"><path stroke="#101828" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2" d="M14.667 7.39v.614a6.667 6.667 0 1 1-3.954-6.093m3.954.756L8 9.34l-2-2"/></g><defs><clipPath id="a"><path fill="#fff" d="M0 0h16v16H0z"/></clipPath></defs></svg>}
            />
          </Box>
          <Box paddingX="8px">
            <FieldMenuItem 
              ...
              title="Autofill"
              icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><path stroke="#101828" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2" d="M13.333 8.334v-3.8c0-1.12 0-1.68-.218-2.108a2 2 0 0 0-.874-.875c-.427-.218-.987-.218-2.108-.218H5.867c-1.12 0-1.68 0-2.108.218a2 2 0 0 0-.874.875c-.218.427-.218.987-.218 2.107v6.934c0 1.12 0 1.68.218 2.108a2 2 0 0 0 .874.874c.428.218.988.218 2.108.218H8m1.333-7.333h-4M6.667 10H5.333m5.334-5.333H5.333m4.334 8L11 14l3-3"/></svg>}
            />
          </Box>
          <Box paddingX="8px">
            <FieldMenuItem
          ...
          <Box paddingX="8px">
            <FieldMenuItem
              ...
              title="Field Hide"
              icon={<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"><path stroke="#101828" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2" d="M7.162 3.395c.27-.04.55-.062.838-.062 3.404 0 5.637 3.004 6.387 4.192.09.143.136.215.162.326a.784.784 0 0 1 0 .298c-.026.11-.071.183-.163.328-.2.316-.505.761-.908 1.243M4.483 4.477c-1.441.977-2.42 2.336-2.869 3.047-.091.144-.137.216-.162.327a.782.782 0 0 0 0 .298c.025.11.07.183.161.326.75 1.188 2.984 4.192 6.387 4.192 1.373 0 2.555-.489 3.526-1.15M2 2l12 12M6.586 6.586a2 2 0 0 0 2.828 2.828"/></svg>}
            />
          </Box>
        </Box>
      </Box>
