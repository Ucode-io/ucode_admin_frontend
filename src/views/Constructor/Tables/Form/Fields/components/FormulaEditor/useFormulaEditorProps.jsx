...
import { countArgsInside, CUSTOM_FUNCTIONS_META, installCustomFunctions, SIG } from "./constants";
...
export const useFormulaFieldProps = () => {
  ...
  function handleEditorMount(editor, monaco){
    ...
    monaco.languages.setMonarchTokensProvider('formula-lang', {
      tokenizer: {
        root: [
          ...
          [/\b(SINGLE_LINE|MULTI_LINE|EMAIL|INTERNATION_PHONE|LOOKUP|LOOKUPS|TEXT|NUMBER|DATE|TIME|DATE_TIME|DATE_TIME_WITHOUT_TIME_ZONE|CHECKBOX|SWITCH)\b/, 'custom-type'],
    ...
    completionProviderRegistered = monaco.languages.registerCompletionItemProvider('formula-lang', {
  ...
  monacoRef.current?.editor?.defineTheme("badge-theme", {
    ...
    inherit: true,
    rules: [
      { token: "keyword", foreground: "#0077aa", background: "007acc", fontStyle: "normal" },
      { token: "type", foreground: "#32302c", background: "54483126", fontStyle: "normal" },
  ...
  return {value, setValue, runValidation, handleEditorMount}
}
