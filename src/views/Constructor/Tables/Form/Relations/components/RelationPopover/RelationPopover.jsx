...
export const RelationPopover = ({ open, anchorEl, onClose, formType, relation, getRelationFields, closeSettingsBlock }) => {
  ...
  const {
    ...
    register,
    submitHandler,
  } = useRelationPopoverProps({ relation, formType, getRelationFields, closeSettingsBlock });
