    ...
    >
      <CTableHead>
        <CTableHeadRow>
          ...
          <CTableCell>{t("doc.type")}</CTableCell>
          <CTableCell>{t("doc.number.and.date")}</CTableCell>
          <CTableCell>{t("counterparty")}</CTableCell>
          <CTableCell>{t("doc.number.and.date")}</CTableCell>
          <CTableCell>{t("delivery.cost")}</CTableCell>
          <CTableCell>{t("delivery.cost.with.vat")}</CTableCell>
