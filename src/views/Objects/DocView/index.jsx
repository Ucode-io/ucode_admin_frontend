...
const DocView = ({views, selectedTabIndex, setSelectedTabIndex}) => {
  ...
  const object1 = {
    attributes: {
      ...
      label_ko: "Инглизча номи",
      label_uz: "Номи",
      label_ru: "Название на английском",
    },
    autofill_field: "",
    autofill_table: "",
    automatic: false,
    ...
    id: "eed22c16-dcc1-4238-a873-341984a1c3b5",
    index: "string",
    is_search: true,
    is_system: false,
    is_visible: false,
    label: "Номи",
    minio_folder: "",
    path_slug: "regions_id_2_data.name_en",
    relation_field: "",
    relation_id: "",
    required: false,
    show_label: true,
    slug: "name_en",
    table_id: "ea6dfb6d-2ccd-40f2-a8e5-1c969b4fcd56",
    table_label: "Cities and Regions",
    type: "SINGLE_LINE",
    unique: false,
  };
  ...
  const object2 = {
    ...
    enable_multilanguage: true,
    hide_multilanguage: false,
    id: "4391dc66-50f9-4d66-a6a8-f880fb181fb4",
    index: "string",
    is_search: true,
    is_system: false,
    is_visible: false,
    label: "Номи",
    minio_folder: "",
    path_slug: "regions_id_2_data.name_ru",
    relation_field: "",
    relation_id: "",
    required: false,
    show_label: true,
  ...
  const object3 = {
    ...
    enable_multilanguage: true,
    hide_multilanguage: false,
    id: "12b7d1f7-a977-4e15-9605-f85e17815c9a",
    index: "string",
    is_search: true,
    is_system: false,
    is_visible: false,
    label: "Номи",
    minio_folder: "",
    path_slug: "regions_id_2_data.name_ko",
    relation_field: "",
    relation_id: "",
    required: false,
    show_label: true,
  ...
  const object4 = {
    ...
    enable_multilanguage: true,
    hide_multilanguage: false,
    id: "a8ad1277-b57c-445a-ba7f-2a5d34fd3164",
    index: "string",
    is_search: true,
    is_system: false,
    is_visible: false,
    label: "Номи",
    minio_folder: "",
    path_slug: "regions_id_2_data.name_uz",
    relation_field: "",
    relation_id: "",
    required: false,
    show_label: true,
