...
export default function TimeLineDayDataBlock({ data, fieldsMap, setFocusedDays, view, tabs, datesList, zoomPosition, calendar_from_slug, calendar_to_slug, visible_field, selectedType }) {
  return (
    <>
