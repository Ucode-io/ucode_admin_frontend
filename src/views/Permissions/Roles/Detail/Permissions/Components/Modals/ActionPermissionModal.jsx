...
const ActionPermissionModal = ({ closeModal, control, tableIndex }) => {
  const basePath = `data.tables.${tableIndex}.action_permissions`;
      ...
      <Modal open className="child-position-center" onClose={closeModal}>
        <Card className="PlatformModal">
          <div className="modal-header silver-bottom-border">
            <Typography variant="h4">Action permissions</Typography>
            <ClearIcon
              color="primary"
              onClick={closeModal}
              width="46px"
              ...
              <CTable>
                <CTableHead>
                  <CTableHeadRow>
                    ...
                    <CTableCell w={250}>Action name</CTableCell>
