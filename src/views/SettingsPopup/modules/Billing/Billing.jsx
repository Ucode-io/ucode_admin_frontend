...
export const Billing = () => {
  ...
  return <Box>
    ...
    <Grid container spacing={4} alignItems="stretch" mt="32px">
      <Grid item xs={12} sm={4}>
        <Card sx={{height: "100%", boxShadow: "none", border: "1px solid rgba(55, 53, 47, 0.06)"}}>
          <CardContent sx={{height: "100%", display: "flex", alignItems: "center", padding: "16px", paddingBottom: "16px !important"}}>
      ...
      <Grid item xs={12} sm={4}>
        <Card sx={{height: "100%", boxShadow: "none", border: "1px solid rgba(55, 53, 47, 0.06)"}}>
          <CardContent
            sx={{height: "100%", display: "flex", alignItems: "center", padding: "16px", paddingBottom: "16px !important"}}>
            <Box sx={{display: "flex", alignItems: "center", gap: 2}}>
